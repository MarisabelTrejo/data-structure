...
new_ingrideint = recipe.insert_tail(input("Insert an ingridient:"))
new_ingrideint_2 = recipe.insert_tail(input("Insert an ingridient:"))
print("_________________________________________________")
print(recipe) # linkedlist[ingridient_3, ingridient_2, ingridient_1, last_ingridident, new_ingridient, new_ingridient_2]


print("\n=========== Removing Practice ===========")
recipe.remove_tail()
print(recipe) # linkedlist[ingridient_3, ingridient_2, ingridient_1, last_ingridident, new_ingridient]
recipe.remove_tail()
print(recipe) # linkedlist[ingridient_3, ingridient_2, ingridient_1, last_ingridident]
